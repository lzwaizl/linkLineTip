    ;(function(win, doc) {
        ...
        var lib = {
            ...
            setAttribute: function(dom, obj) {
                for (var v in obj) {
                    dom.setAttribute(v, obj[v]);
                }
            },
        ...
        win.LineTip = function(options) { // common options
            this.color = options.color || "#000";  //
            this.size = options.size || 2;
            this.radius = options.radius || 4;
            this.opacity = options.opacity || 0.5;
            this.animateTime = options.animateTime || 1;
            ...
            this.pointsOps = this.addDefault(options.points);
            this.lineOps = this.addDefault(options.line);
        };

        LineTip.prototype.addDefault = function (options) {
        ...
        LineTip.prototype.countSVGWH = function(options) {
        ...
        LineTip.prototype.formatePoints = function(options) {
        ...
        LineTip.prototype.fixCxCy = function(r, points, strokeWidth) {
        ...
        LineTip.prototype.getValues = function (points, options) {
        ...
        LineTip.prototype.getRotate = function (pos) {
        ...
        LineTip.prototype.add = function(options) {
            ...
            cssStyle += styleDeal.cssStrAnimation("dash_circle", {
                "stroke-dashoffset": this.radius * 2 * Math.PI
            },{
                "stroke-dashoffset": 0
            });   
            ...
            animate.delayLine([
                function () { svg.appendChild(headCircle);   },
                function () { svg.appendChild(polyline);     },
                function () { svg.appendChild(tailCircle);   },
                function () { svg.appendChild(foreignObject);}
            ], [
